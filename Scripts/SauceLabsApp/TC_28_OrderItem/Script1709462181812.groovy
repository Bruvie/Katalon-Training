...
WebUI.click(findTestObject('Object Repository/SwagLab_VerifyCheckoutPage/Page_Swag Labs/button_Finish'))

WebUI.verifyElementText(findTestObject('Object Repository/SwagLab_VerifyCheckoutPage/Page_Swag Labs/h2_Thank you for your order'), 
    'Thank you for your order!')

WebUI.click(findTestObject('Object Repository/SwagLab_VerifyCheckoutPage/Page_Swag Labs/button_Back Home'))
